<main class="max-w-[52rem] mx-auto px-4 pb-28 sm:px-6 md:px-8 xl:px-12 lg:max-w-6xl">
  <header class="py-16 sm:text-center">
    ...
    <p class="text-lg text-slate-700 dark:text-slate-400">All the latest Tailwind CSS news, straight from the team.</p>
  ...
  <div class="relative sm:pb-12 sm:ml-[calc(2rem+1px)] md:ml-[calc(3.5rem+1px)] lg:ml-[max(calc(14.5rem+1px),calc(100%-48rem))]">
    ...
    <div class="space-y-16">
      <article class="relative group">
        ...
        <div class="relative">
          <h3 class="text-base font-bold tracking-tight text-slate-900 dark:text-slate-200 pt-8 lg:pt-0">Automatic Class Sorting with Prettier</h3>
          <div class="mt-2 mb-4 prose prose-slate prose-a:relative prose-a:z-10 dark:prose-dark line-clamp-2">
            <p>People have been talking about the best way to sort your utility classes in Tailwind projects for <a href="https://github.com/tailwindlabs/discuss/issues/97">at least four years</a>. Today we’re excited to announce that you can finally stop worrying about it with the release of our official <a href="https://github.com/tailwindlabs/prettier-plugin-tailwindcss">Prettier plugin for Tailwind CSS</a>.</p>
          </div>
          <dl class="absolute left-0 top-0 lg:left-auto lg:right-full lg:mr-[calc(6.5rem+1px)]">
            <dt class="sr-only">Date</dt>
            <dd class="whitespace-nowrap text-sm leading-6 dark:text-slate-400"><time dateTime="2022-01-24T19:00:00.000Z">January 24, 2022</time></dd>
          </dl>
        </div><a class="flex items-center text-sm text-sky-500 font-medium" href="/blog/automatic-class-sorting-with-prettier"><span class="absolute -inset-y-2.5 -inset-x-4 md:-inset-y-4 md:-inset-x-6 sm:rounded-2xl"></span><span class="relative">Read more<span class="sr-only">,
