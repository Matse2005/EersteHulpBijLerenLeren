                ...
                <tr class="text-gray-700 dark:text-gray-400">
                  <td class="px-4 py-3">
                    <div class="flex items-center text-sm">
                      <div>
                        <p class="font-source-code-pro font-semibold bg-secondary focus:outline-none focus:border-none focus:ring-0 w-full h-auto"><?php print $credit["content"] ?></p>
                      </div>
                    </div>
                  </td>
                  <td class="px-4 py-3 text-sm">
                    <p class="font-source-code-pro font-semibold bg-secondary focus:outline-none focus:border-none focus:ring-0 w-full h-auto"><?php print $credit["url"] ?></p>
                  </td>
                  <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                      <form action="" method="POST">
                        <button type="submit" name="remove" value="<?php print $credit["id"] ?>" class="flex items-center text-white bg-black px-4 py-2 justify-between text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete">
                          Verwijderen
                        </button>
                      </form>
                    </div>
